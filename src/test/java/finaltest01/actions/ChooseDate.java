...
//        WaitUntil.the(START_TIME, isVisible()).forNoMoreThan(10).seconds();
//        START_TIME.resolveFor(t).click();
//        WaitUntil.the(END_TIME, isVisible()).forNoMoreThan(10).seconds();
//        END_TIME.resolveFor(t).click();
        t.attemptsTo(
                WaitUntil.the(START_TIME, isVisible()).forNoMoreThan(10).seconds(),
                Click.on(START_TIME),
                WaitUntil.the(END_TIME, isVisible()).forNoMoreThan(10).seconds(),
